...
const About = () => {
  return (
    <div className='about-container'>
        ...
        <p>This is a personal/learning project that I wanted to make to help grow my breadth and depth of knowledge.
        ...
        <h3>The Goal</h3>
        <p>For now a user will only be able to see recipes they have uploaded, but the final goal with this project is to make it so you can look up another person's profile to see their recipes.</p>
        <h3>Takeaways</h3>
        <p>
